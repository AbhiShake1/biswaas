<footer class="border-t bg-muted/30">
  <div class="container mx-auto px-4 py-8">
    <div class="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
      ...
      <div>
        <h4 class="mb-3 text-sm font-semibold">Categories</h4>
        <ul class="space-y-2 text-sm text-muted-foreground">
          <li><a href="/categories/education-consultancies" class="hover:text-foreground">Education Consultancies</a></li>
          <li><a href="/categories/ecommerce" class="hover:text-foreground">E-Commerce</a></li>
          <li><a href="/categories/trekking-tourism" class="hover:text-foreground">Trekking & Tourism</a></li>
          <li><a href="/categories/isp-telecom" class="hover:text-foreground">ISPs & Telecom</a></li>
          <li><a href="/categories/hospitals-healthcare" class="hover:text-foreground">Hospitals & Healthcare</a></li>
        </ul>
      </div>
    ...
    <div class="mt-8 border-t pt-6 text-center text-xs text-muted-foreground">
      <p>&copy; {new Date().getFullYear()} Biswaas (विश्वास). Built for Nepal.</p>
    </div>
  </div>
</footer>
